(function() {
  ...
  progress = function(percent) {
    ...
    return process.stdout.write(' ['.grey + BAR.substr(0, rounded).green + NOBAR.substr(0, 50 - rounded) + '] '.grey + percent.bold.cyan + '%'.grey + '\r');
  };
  logerr = function(err) {
  ...
  switch (options.action) {
    ...
    case 'edit':
      ...
      nt.edit(options.files[0], options, function(err, output) {
        ...
        return console.log("File written to " + output);
      });
      break;
    case 'hash':
