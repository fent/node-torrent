 ...
 * @return {!String} Possible error
 */
var checkAnnounceList = exports.announceList = (list) => {
  if (list) {
 ...
 * @return {!String} Possible error
 */
var md5sumRegexp = /[a-f0-9]{32}/i;
var checkmd5sum = (parent) => {
 ...
 */
var checkTorrent = exports.checkTorrent = (torrent) => {
  var err;
